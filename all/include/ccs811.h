...
#define CCS811_I2C_ADDR                 0xB4    //This is already left shifted 0x5B, if using other address, should be 0xB4 which is 0x5A left shifted.
...
class CCS811 {
    public:
        ...
        int readData(float *ECO2, float *TVOC);
        bool checkHW();
        bool softRest();
        bool readstatus();
        bool readmeas();
